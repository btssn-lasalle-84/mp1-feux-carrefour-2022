...
CREATE TABLE IF NOT EXISTS `MODE` (`idMode` int(11) NOT NULL AUTO_INCREMENT, `nomMode` varchar(255) NOT NULL, PRIMARY KEY (`idMode`), CONSTRAINT Unique_NomClub UNIQUE (`nomMode`)) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--- Crée la table MODE

CREATE TABLE IF NOT EXISTS `SEQUENCE` (`idSequence` int(11) NOT NULL AUTO_INCREMENT, `numeroSequence` int(11) NOT NULL, `idMode` int(11) NOT NULL, `F1` VARCHAR(3) NOT NULL DEFAULT '000', `F2` VARCHAR(3) NOT NULL DEFAULT '000', `F3` VARCHAR(3) NOT NULL DEFAULT '000', `F4` VARCHAR(3) NOT NULL DEFAULT '000', `F5` VARCHAR(3) NOT NULL DEFAULT '000', `FP1` VARCHAR(2) NOT NULL DEFAULT '00', `FP2` VARCHAR(2) NOT NULL DEFAULT '00', `Duree` INT(11) NOT NULL DEFAULT 0, PRIMARY KEY (`idSequence`), CONSTRAINT Unique_SEQUENCE UNIQUE (`idSequence`,`numeroSequence`), CONSTRAINT SEQUENCE_fk_1 FOREIGN KEY (`idMode`) REFERENCES MODE(`idMode`) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO MODE (idMode, nomMode) VALUES (NULL,'NUIT');
--- Table SEQUENCE
...
INSERT INTO `SEQUENCE` (`numeroSequence`, `idMode`, `F1`, `F2`, `F3`, `F4`, `F5`, `FP1`, `FP2`, `Duree`) VALUES ('1', '3', '010', '010', '100', '100', '001', '00', '00', 5), ('2', '3', '000', '000', '100', '100', '100', '00', '00', 6);
